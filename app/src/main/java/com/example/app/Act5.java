...
public class Act5 extends AppCompatActivity {
    ...
    public void openAct3(){
        ...
        ch_1 = findViewById(R.id.checkBox90);
        ch_2 = findViewById(R.id.checkBox20);
        ch_3 = findViewById(R.id.checkBox30);
        r_Black = findViewById(R.id.radioButton40);
        r_White = findViewById(R.id.radioButton50);
        r_Green = findViewById(R.id.radioButton60);
        r_Blue = findViewById(R.id.radioButton70);
        sw=findViewById(R.id.switch10);
